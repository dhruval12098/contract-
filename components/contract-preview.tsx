...
export function ContractPreview({ contract, agency }: ContractPreviewProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-900 rounded-lg p-6 min-h-[600px] text-sm leading-relaxed shadow-inner border"
    ...
    >
      ...
      <div className="mt-6 pt-4 border-t border-gray-200 text-center text-xs text-gray-500">
        ...
        <p>Generated by ContractAI on {new Date().toLocaleDateString()}</p>
      </div>
    </motion.div>
  )
}
